...
df_fp16 = scripts.compile_results_pytorch_throughput.main('--path results/ --precision fp16 --system single'.split())
df_fp32 = scripts.compile_results_pytorch_throughput.main('--path results/ --precision fp32 --system single'.split())
