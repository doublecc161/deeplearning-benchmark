...
list_system_single = [
   ...
   ('2080L2', 'RTX 2080 L2', 245, 500),
   ('2080L3', 'RTX 2080 L3', 245, 500),
   ('2080L3SYN', 'RTX 2080 L3 245', 220, 500),
   ('3070', 'RTX 3070', 220, 1035),
   ('3070L2', 'RTX 3070 L2', 220, 700),
   ('3070L3', 'RTX 3070 L3', 220, 700),
   ('3070L3SYN', 'RTX 3070 L3 SYN', 220, 7000),
